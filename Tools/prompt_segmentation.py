...
- Use present participle: "standing", "walking", "running", "biking", "holding", "waving"
...
- "electric_vehicle" if being ridden
- "none" otherwise
...
# 15. Scarf
prompt_15 = """Detect wearing scarf:
Wearing a scarf: Output the scarf color if present; otherwise "none".
- Output color with modifiers if present
- "none" if no scarf

Example Input: "blue silk scarf"
Output: {"Wearing a scarf":"blue"}
